...
public class Nvl5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_marromEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 285, 370, 30));
        ...
        getContentPane().add(lbl_laranjaEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 250, 320, 50));
        ...
        getContentPane().add(lbl_marrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 285, 370, 30));
        ...
        getContentPane().add(lbl_pnt, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 110, 40));
        ...
        getContentPane().add(lbl_pntsNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 10, 120, 40));
        ...
        getContentPane().add(lbl_replay, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 0, 70, 70));
    ...
    private void lbl_verdeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_verdeMouseClicked
        if (aux == 6){
            ...
            Cartinha_Parabens obj = new Cartinha_Parabens();
            obj.setVisible(true);
            dispose();
            score +=10;
            lbl_pnt.setText(String.valueOf(score));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nvl5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
