...
public class Nvl3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_vermelhoEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 400, 30));
        ...
        getContentPane().add(lbl_vermelho, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 400, 30));
        ...
        getContentPane().add(lbl_azul, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 500, 610, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nvl3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
