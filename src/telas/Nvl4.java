...
public class Nvl4 extends javax.swing.JFrame {
    ...
    public Nvl4() {
        ...
        lbl_laranja.setVisible(false);
        lbl_marrom.setVisible(false);
        ...
        lbl_marromEs.setVisible(false);
        lbl_laranjaEs.setVisible(false);
    ...
    private void initComponents() {
        ...
        lbl_laranjaEs = new javax.swing.JLabel();
        lbl_marromEs = new javax.swing.JLabel();
        ...
        lbl_marrom = new javax.swing.JLabel();
        ...
        lbl_laranjaEs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img_cores/laranjaescuro.png"))); // NOI18N
        lbl_laranjaEs.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(lbl_laranjaEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 260, 320, 40));

        lbl_marromEs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img_cores/marromesc.png"))); // NOI18N
        lbl_marromEs.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        getContentPane().add(lbl_marromEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 280, 370, 40));
        ...
        getContentPane().add(lbl_roxoEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 390, 20));
        ...
        getContentPane().add(lbl_amareloEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 420, 40));
        ...
        getContentPane().add(lbl_azulEs, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 500, 540, 60));
        ...
        getContentPane().add(lbl_amarelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 420, 40));
        ...
        getContentPane().add(lbl_roxo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 320, 390, 20));

        lbl_marrom.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img_cores/marromclar.png"))); // NOI18N
        lbl_marrom.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lbl_marrom.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbl_marromMouseClicked(evt);
            }
        });
        getContentPane().add(lbl_marrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 280, 370, 40));

        lbl_laranja.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img_cores/laranjaclaro.png"))); // NOI18N
        lbl_laranja.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        lbl_laranja.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbl_laranjaMouseClicked(evt);
            }
        });
        getContentPane().add(lbl_laranja, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 310, 40));
        ...
        getContentPane().add(lbl_pntsNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 10, 160, 40));
        ...
        getContentPane().add(lbl_cenario, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 600));
    ...
    private void lbl_marromMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_marromMouseClicked
        if (aux == 3){
            
             aux++;
             lbl_marromEs.setVisible(true);
             score +=10;
             lbl_pnt.setText(String.valueOf(score));    
    ...
    }//GEN-LAST:event_lbl_marromMouseClicked

    private void lbl_laranjaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_laranjaMouseClicked
        if (aux == 0){
            
            aux++;
            lbl_laranjaEs.setVisible(true);
            score +=10;
            lbl_pnt.setText(String.valueOf(score));
    ...
    }//GEN-LAST:event_lbl_laranjaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nvl4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lbl_laranjaEs;
    private javax.swing.JLabel lbl_marrom;
    private javax.swing.JLabel lbl_marromEs;
